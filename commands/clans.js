module.exports.execute = async (client, message) => message.channel.send(`⚔ Here is our list of KOA Clans! ⚔
	...
	🔸 **The Students**: Academics & all things Education by **colin**#3523 (Position Open!)
