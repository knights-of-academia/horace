module.exports.execute = async (client, message) => await message.channel.send(`To submit a feature, simply click on the link below and submit a request. Our Engineering Team will sort through these requests and once approved, build them in the following Horace update/patch. If you know Javascript or want to learn, feel free to submit a Pull Request!
