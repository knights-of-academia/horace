      ...
      Afks.create({
        ...
        if (err.name === 'SequelizeUniqueConstraintError') {
          Afks.destroy({
            ...
            return consola.error('Could not find user.');
          });
        }
        consola.error('AFK sequelize error: ', err);
      });
    } else {
      Afks.destroy({
        where: {
        ...
        return consola.error('Could not find user to delete AFK.');
      });
    }
  }));
};
